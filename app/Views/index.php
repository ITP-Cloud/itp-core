  ...
  <main class="main" id="top">
    ...
    <section class="pt-5 pt-md-9 mb-6" id="feature">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="<?= base_url() ?>/fassets/img/category/icon1.png" width="75" alt="Feature" />
            <h4 class="mb-3">First click tests</h4>
            <p class="mb-0 fw-medium text-secondary">While most people enjoy casino gambling,</p>
          </div>
          <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="<?= base_url() ?>/fassets/img/category/icon2.png" width="75" alt="Feature" />
          ...
          <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="<?= base_url() ?>/fassets/img/category/icon3.png" width="75" alt="Feature" />
            <h4 class="mb-3">Preference tests</h4>
            <p class="mb-0 fw-medium text-secondary">The Myspace page defines the individual.</p>
          </div>
          <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="<?= base_url() ?>/fassets/img/category/icon4.png" width="75" alt="Feature" />
    ...
    <section class="pt-5" id="validation">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6"><img class="img-fluid" src="<?= base_url() ?>/fassets/img/validation/validation.png" alt="" /></div>
        </div>
      </div><!-- end of .container-->
    ...
    <section class="pt-5" id="manager">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6"><img class="img-fluid" src="<?= base_url() ?>/fassets/img/manager/manager.png" alt="" /></div>
          <div class="col-lg-6">
            ...
            <div class="d-flex align-items-center mb-3"> <img class="me-sm-4 me-2" src="<?= base_url() ?>/fassets/img/manager/tick.png" width="35" alt="tick" />
    ...
    <section class="pt-5" id="marketer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6"><img class="img-fluid" src="<?= base_url() ?>/fassets/img/marketer/marketer.png" alt="" /></div>
        </div>
      </div><!-- end of .container-->
    ...
    <section class="py-md-11 py-8" id="superhero">
      ...
      <div class="bg-holder z-index--1 bottom-0 d-none d-lg-block background-position-top" style="background-image:url(<?= base_url() ?>/fassets/img/superhero/oval.png);opacity:.5; background-position: top !important ;">
      </div>
      <!--/.bg-holder-->
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4 mb-4">
            <div class="card"><img class="card-img-top" src="<?= base_url() ?>/fassets/img/marketing/marketing01.png" alt="" />
          ...
          <div class="col-md-4 mb-4">
            <div class="card"><img class="card-img-top" src="<?= base_url() ?>/fassets/img/marketing/marketing02.png" alt="" />
              <div class="card-body ps-0">
                <p class="text-secondary">By <a class="fw-bold text-decoration-none me-1" href="#">Abdullah</a>|<span class="ms-1">03 March 2019</span></p>
          ...
          <div class="col-md-4 mb-4">
            <div class="card"><img class="card-img-top" src="<?= base_url() ?>/fassets/img/marketing/marketing03.png" alt="" />
              <div class="card-body ps-0">
                <p class="text-secondary">By <a class="fw-bold text-decoration-none me-1" href="#">Abdullah</a>|<span class="ms-1">03 March 2019</span></p>
    ...
    <section class="pb-2 pb-lg-5">
      ...
      <div class="container">
        <div class="row border-top border-top-secondary pt-7">
          <div class="col-lg-3 col-md-6 mb-4 mb-md-6 mb-lg-0 mb-sm-2 order-1 order-md-1 order-lg-1"><img class="mb-4" src="<?= base_url() ?>/fassets/img/logo.svg" width="184" alt="" /></div>
          ...
          <div class="col-lg-3 col-md-6 col-6 mb-4 mb-lg-0 order-2 order-md-2 order-lg-4">
            ...
            <button class="btn btn-primary fw-medium py-1">Sign up Now</button>
          </div>
        </div>
      </div><!-- end of .container-->
